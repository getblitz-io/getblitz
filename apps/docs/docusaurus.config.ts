...
const config: Config = {
  ...
  tagline: "SEPA Instant Transfer Payment Gateway",
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: "https://app.getblitz.io/api-reference",
          label: "API Reference",
          position: "left",
        },
        {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} GetBlitz. Built with Docusaurus.`,
    },
    prism: {
